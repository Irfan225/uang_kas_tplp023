...
function addSiswa($data) {
	...
	$query = mysqli_query($conn, "INSERT INTO siswa VALUES ('', '$nim', '$nama_siswa', '$jenis_kelamin', '$no_telepon', '$email')");
  	return mysqli_affected_rows($conn);
}
...
function editSiswa($data) {
	...
	$no_telepon = htmlspecialchars($data['no_telepon']);
	$email = htmlspecialchars($data['email']);
	$query = mysqli_query($conn, "UPDATE siswa SET nim = '$nim', nama_siswa = '$nama_siswa', jenis_kelamin = '$jenis_kelamin', no_telepon = '$no_telepon', email = '$email' WHERE id_siswa = '$id_siswa'");
  	return mysqli_affected_rows($conn);
}
