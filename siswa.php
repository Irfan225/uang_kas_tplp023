                    ...
                    <tr>
                      ...
                      <?php if ($_SESSION['id_jabatan'] !== '3'): ?>
                        <td>
                          ...
                          <a href="ubah_siswa.php?id_siswa=<?= $ds['id_siswa']; ?>" class="m-1 badge badge-success" data-toggle="modal" data-target="#editSiswa<?= $ds['id_siswa']; ?>">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <div class="form-group">
                                      ...
                                      <input type="text" id="nim<?= $ds['id_siswa']; ?>" value="<?= $ds['nim']; ?>" name="nim" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                          ...
                          <?php if ($_SESSION['id_jabatan'] == '1'): ?>
                            <a data-nama="<?= $ds['nama_siswa']; ?>" class="btn-delete m-1 badge badge-danger" href="hapus_siswa.php?id_siswa=<?= $ds['id_siswa']; ?>"><i class="fas fa-fw fa-trash"></i> Hapus</a>
                          <?php endif ?>
                        </td>
                      <?php endif ?>
                    </tr>
