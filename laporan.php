<?php 
  ...
  if (isset($_POST['btnLaporanPemasukkan'])) {
	if (isset($_POST['id_bulan_pembayaran'])) {
		$id_bulan_pembayaran = htmlspecialchars($_POST['id_bulan_pembayaran']);
		if ($id_bulan_pembayaran != null) {
	  		$sql = mysqli_query($conn, "SELECT * FROM bulan_pembayaran INNER JOIN uang_kas ON bulan_pembayaran.id_bulan_pembayaran = uang_kas.id_bulan_pembayaran INNER JOIN siswa ON uang_kas.id_siswa = siswa.id_siswa WHERE bulan_pembayaran.id_bulan_pembayaran = '$id_bulan_pembayaran' ORDER BY siswa.nama_siswa ASC");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
      	<?php if ($error == true): ?>
      		<div class="row justify-content-left not-printed">
	      		<div class="col-lg-4">
	      			<div class="alert alert-danger alert-dismissible fade show" role="alert">
					  <p class="my-auto">Tidak memilih bulan pembayaran!</p>
        		...
        		<form method="post">
        			<div class="form-group">
	        			...
	        			<select name="id_bulan_pembayaran" id="id_bulan_pembayaran" class="form-control">
	        				<?php if (isset($_POST['id_bulan_pembayaran'])): ?>
